...
sortedList.each { buildFile ->
	...
	println "***** Ray Lam Processor parms for $buildFile = $ProcessorParm"
	 ...
	 Date start = new Date()
	 println "***** Ray Lam Start time before call: $start\n "
	...
	String jsonfile = compileUtils.compileParms(processorMember)
	println "***** Ray Lam after returned from compileUtils Json file -> $jsonfile\n "
    
	Date stop = new Date()
	println "***** Ray Lam End time after call: $stop\n " 
	//println(stop.getTime())
	
	TimeDuration td = TimeCategory.minus( stop, start )
	println "***** Ray Lam time duration after call: $td\n"
...
def parseProcessor(String buildFile, LogicalFile logicalFile, String member, File logFile) {
